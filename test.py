...
def test_simulator():
    ...
    modify_rou_flow_rate('lightSync.rou.xml', 0.5, setting.STEP)  # Change 'input.xml' to the path of your XML file
    ...
    plot_simulation_graph(conf[0][0][1].metrics_for_stats['completed_lifetimes'], conf[0][0][1].arrival_time)
